...
@section('content')
    ...
    <br>
    <h3 align="center" style="margin-top: 7%"><div class="product-about">
            @if(!$product->status)
                <span class="price"><i class="fa fa-rub"></i>
                Нет в наличии </span> @else
                <span class="price" style="color: green; text-transform: uppercase"><i class="fa fa-rub"></i> В наличии </span> @endif
            <p class="fa fa-rub"style="text-transform: uppercase">{{$product->price}} р/кг</p>
        </div> </h3>
    <h6  align="center mt-4"><canvas id="my_canvas" style="width: 100%;"></canvas></h6>
    <script>
